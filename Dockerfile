...
#COPY china-latest.osm.pbf /app/src/data.osm.pbf
COPY china-latest.osm.pbf /app/src/data.osm.pbf
COPY country_grid.sql.gz /app/src/data/country_osm_grid.sql.gz
...
RUN service postgresql start && \
    ...
    sudo -u nominatim ./src/build/utils/setup.php --osm-file /app/src/data.osm.pbf  --all --threads 8 && \
